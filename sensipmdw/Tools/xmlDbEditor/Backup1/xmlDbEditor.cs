...
namespace xmlDbEditor
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.rdbPK = new System.Windows.Forms.CheckBox();
            ...
            // groupBox2
            // 
            this.groupBox2.Controls.Add(this.rdbPK);
            ...
            // rdbPK
            // 
            this.rdbPK.AutoSize = true;
            this.rdbPK.Location = new System.Drawing.Point(58, 75);
            this.rdbPK.Name = "rdbPK";
            this.rdbPK.Size = new System.Drawing.Size(42, 17);
            this.rdbPK.TabIndex = 11;
            this.rdbPK.Text = "PK";
            this.rdbPK.UseVisualStyleBackColor = true;
            this.rdbPK.CheckedChanged += new System.EventHandler(this.rdbPK_CheckedChanged_1);
            // 
            // lvColumns
            // 
		...
		private void btnAddColumn_Click(object sender, System.EventArgs e)
		{
			...
			DataColumn col = currentTable.Columns.Add(colName, Type.GetType("System."+colType));

            if (rdbPK.Checked == true)
                currentTable.PrimaryKey = new DataColumn[]{col}; 
		}
...
//			currentTable.Columns[edColumnName.Text].DataType=Type.GetType("System."+cbColumnType.Text);
        ...
        private void rdbPK_CheckedChanged_1(object sender, EventArgs e)
        {
            if (lvColumns.SelectedItems.Count > 0)
            {
                string x = lvColumns.SelectedItems[0].Text;
                if (x != "" && rdbPK.Checked == true)
                    currentTable.PrimaryKey = new DataColumn[] { currentTable.Columns[x] };
            }
        }
	}
}
